package br.com.senaisp.bauru.isabela.licao04.secao01;
...
public class FestaAlex {
	...
	public static void main(String[] args) {
		...
		// ao em vez de: double total1 = pessoa1*(1+0.05) * (1+0.15); 
		//foi criado as variaveis final double
		//double total1 = pessoa1 * (1+IMPOSTO)* (1+GORJETA);
		// mesmo assim foi criado metodos por causa de tanta repetição, 
		//movendo as constantes para final static double. ex:
