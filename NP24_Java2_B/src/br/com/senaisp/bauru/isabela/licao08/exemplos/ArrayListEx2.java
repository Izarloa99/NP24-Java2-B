package br.com.senaisp.bauru.isabela.licao08.exemplos;
...
public class ArrayListEx2 {
    public static void main(String args[]) {
        ...
        while (iter.hasNext()) {
         ...
         /* removendo os pares => isso ode dar problemas porque eu perco a referencia de indices
        for (int it: lstInt) {
        	if (it%2==0) {
        ...
        //para resolver o problemas use: (para remover a partir do indice do maior para o menor)
