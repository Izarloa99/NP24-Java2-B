package br.com.senaisp.bauru.isabela.licao09.exemplo02;
...
public class AplicacaoJavaFX extends Application {
	...
	private void criarComponentes(Group root) {
        ...
        //Criando o retangulo
		Rectangle rec = new Rectangle(150, 150, Color.BLACK);
		rec.setLayoutX(50);
		rec.setLayoutY(50);

		// Colocando contorno
		rec.setStroke(Color.DARKVIOLET);
		rec.setStrokeWidth(10);

		// Adicionando o rectangle ao nó root
